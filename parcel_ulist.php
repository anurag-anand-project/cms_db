		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$w = $_SESSION['login_firstname'];
					
					$qry = $conn->query("SELECT * from parcels where sender_name='$w' order by  unix_timestamp(date_created) desc ");
...
<script>
	$(document).ready(function(){
		...
		$('.view_parcel').click(function(){
			uni_modal("Parcel's Details","view_uparcel.php?id="+$(this).attr('data-id'),"large")
		})
