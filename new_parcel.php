...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="sender_name" id="" onkeypress="abc1(event)" class="form-control form-control-sm" value="<?php echo isset($sender_name) ? $sender_name : '' ?>" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="sender_contact" id="contact" onkeypress="abc(event)" class="form-control form-control-sm" value="<?php echo isset($sender_contact) ? $sender_contact : '' ?>" required>
              </div>
          </div>
          <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="" class="control-label">Name</label>
                <input type="text" name="recipient_name" id="" onkeypress="abc1(event)" class="form-control form-control-sm" value="<?php echo isset($recipient_name) ? $recipient_name : '' ?>" required>
              </div>
              <div class="form-group">
                <label for="" class="control-label">Address</label>
              ...
              <div class="form-group">
                <label for="" class="control-label">Contact #</label>
                <input type="text" name="recipient_contact" id="contact1" onkeypress="abcs(event)" class="form-control form-control-sm" value="<?php echo isset($recipient_contact) ? $recipient_contact : '' ?>" required>
              </div>
          </div>
        </div>
        <hr>
        ...
        <table class="table table-bordered" id="parcel-items">
          ...
          <tbody>
            <tr>
              <td><input type="text" size="15" name='weight[]' value="<?php echo isset($weight) ? $weight :'' ?>" required></td>
              <td><input type="text" size="15" name='height[]' value="<?php echo isset($height) ? $height :'' ?>" required></td>
              <td><input type="text" size="15" name='length[]' value="<?php echo isset($length) ? $length :'' ?>" required></td>
              <td><input type="text" size="15" name='width[]' value="<?php echo isset($width) ? $width :'' ?>" required></td>
              <td><input type="text" class="text-right number" size="15" name='price[]' value="<?php echo isset($price) ? $price :'' ?>" required></td>
...
var c=String.fromCharCode(e.which);
	...
	if(document.getElementById('contact').value==2 || document.getElementById('contact').value==1 || document.getElementById('contact').value==3 || document.getElementById('contact').value==4 || document.getElementById('contact').value==5)
	{
...
var c=String.fromCharCode(e.which);
	...
	if(document.getElementById('contact1').value==2 || document.getElementById('contact1').value==1 || document.getElementById('contact1').value==3 || document.getElementById('contact1').value==4 || document.getElementById('contact1').value==5)
	{
		document.getElementById('contact1').value='';
		e.preventDefault();
	}
	if((document.getElementById('contact1').value).length ==10)
	{
		e.preventDefault();
	}
}
